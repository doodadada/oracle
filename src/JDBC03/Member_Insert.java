...
public class Member_Insert {
	public static void main(String[] args) throws ParseException {
		...
		// bpoint는 default값이 0이므로 별도로 입력받지 않습니다
		
		// 생년월일 입력 - simpleDateFormat 과 Exception을 이용하여 Exception을 이용하여 입력을 받을 예정
		// String으로 받아서 java.util.Date 형식으로 변환 후 java.sql.Date로 변환
		...
		// sdf 객체에 날짜 데이터 하나를 적용하면 "yyyy-MM-dd" 양식으로 날짜데이터를 설정하여 사용할 수 있습니다
		// 또한 SimpleDateFormat 클래스의 parse 메서드는 String 양식의 날짜데이터를
		// 실제 java.util.Date 로 변환해줍니다.
